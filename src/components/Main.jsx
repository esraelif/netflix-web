...
const Main = () => {
    ...
    //*Herseferinde main de farklı bir film gostersin diye
    ...
    useEffect(() => {
        ...
        fetch('https://api.themoviedb.org/3/movie/popular?language=en-US&page=1', options)
            ...
            .then(data => {
                setMovies(data.results); // Veriyi setMovies fonksiyonu ile state'e atama yaptım
            })
            .catch(err => console.error(err));
    }, []);
    // console.log(movie)
    //*overwiew 150 harften fazla olanları 3nokta ile gostermesi için:
    ...
    return (
        <div className='w-full h-[550px] text-white '>
            <div className='w-full h-full'>
                ...
                <img className='w-full h-full object-cover' src={`https://image.tmdb.org/t/p/original/${movie.backdrop_path}/images`} />
